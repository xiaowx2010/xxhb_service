...
namespace OralSync
{
    ...
    public  class OracleHelper
    {
        ...
        public OracleHelper(string conn_str)
        {
            connstr = conn_str;
        }
        //数据库连接字符串
        //(DESCRIPTION=(ADDRESS=(PROTOCOL=TCP)(HOST=10.101.59.84)(PORT=1521))(CONNECT_DATA=(SID=Orcl)))
        //private readonly static string connstr = ConfigurationManager.ConnectionStrings["ConnectionStrings"].ConnectionString;
        //private readonly static string connstr = "Data Source=XE;User Id=xh;Password=xwx;Integrated Security=no;";
        //private readonly static string connstr = "Data Source=(DESCRIPTION=(ADDRESS=(PROTOCOL=TCP)(HOST=10.101.59.84)(PORT=1521))(CONNECT_DATA=(SID=Orcl)));User Id=xh;Password=xh1314!;";
        //private readonly static string connstr = "Data Source=(DESCRIPTION=(ADDRESS=(PROTOCOL=TCP)(HOST=192.168.1.111)(PORT=1521))(CONNECT_DATA=(SERVICE_NAME=XE)));User Id=xh;Password=xwx;";
